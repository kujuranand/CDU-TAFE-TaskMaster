...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private bool _canMove = true; // Anand
        ...
        // Method to enable movement, called by the animation event
        ...
        private void Update()
        {
            ...
            if (_hasAnimator)
            {
                ...
                // Anand
                if (animatorState.IsName("PickObject") || animatorState.IsName("Inspect") || animatorState.IsName("Angry"))
                {
                    _canMove = false;
                }
                else
